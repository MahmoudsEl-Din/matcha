                    ...
                    $.get('/notif/get_user', {id: elem['uid_sender']}, function(data, jqHXR) {
                        if (jqHXR === "success") {
                            ...
                            if (elem['type'] === 1) {
                                ...
                                $('#div_notif_views').prepend('<a class=\'w-100 m-2 h-25 \'id=\''+key+'\' href(\'#\')><div class=\'notif\'' + style + ' >' + content + '</div></a>')
                                ...
                                $('#div_notif_likes').prepend('<a class=\'w-100 m-2 h-25 \'id=\''+key+'\' href(\'#\')><div class=\'notif\'' + style + ' >' + content + '</div></a>')
                                $('#'+key).click(function() {window.location.replace('/user?uid='+elem['uid_sender'])})                                
                            }
                        }
                    })
