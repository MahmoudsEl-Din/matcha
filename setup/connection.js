        ...
        this.connection.query(sql, (error, results) => {
            ...
            if (results.length === 0) {
                sql = "INSERT INTO `users` (`id`, `username`, `name`, `password`, `lastname`, `email`, `genre`, `desire`, `bio`, `age`, `lat`, `lng`) VALUES" +
                    ...
                    "(2, 'jm', 'Jean Miche', '3fa8f47591f813a163493ba2e89c611e021975203aae23c25da91bfa65e9561f508b6ea672c47f7cfce7d1d93a8921caae6cd4d2464dac8add911480cabdbfc4', 'Sabourin', 'jean_miche@mailinator.com', 'M', 'B', 'I'd like to meet nice girls or men', 56,45.845725, 4.939478)" + //mdp = Test1234
                    ...
                    "(7, 'LeaPassionCheval', 'Lea', '450a3792b22bfdae3bd8c144507d90ac08f4368168d63871b90187bb06ed59ab55dbf099a73f8b37f293353e5302fc967d57612766bc72e203392296548978dc', 'Blanc', 'cheval.love@mailinator.com', 'F', 'M', 'Si t'es un cheval like moi', 24,43.593909, 4.468983)" + //mdp = ChevalAmour6                                                                
                    // "(7, 'LeaPassionCheval', 'Lea', '450a3792b22bfdae3bd8c144507d90ac08f4368168d63871b90187bb06ed59ab55dbf099a73f8b37f293353e5302fc967d57612766bc72e203392296548978dc', 'Blanc', 'cheval.love@mailinator.com', 'F', 'M', 'Si t'es un cheval like moi', 24,45.764043, 4.835659)" + //mdp = ChevalAmour6                                                                
